...
function parser() {
  ...
  function parse_decl() {
    ...
    return stative(
      interpolation_qualification_or_not,
      invariant_or_not,
      storage_or_not,
      parameter_or_not,
      precision_or_not,
    ...
    function interpolation_qualification_or_not() {
      if (is_interpolation_qualification(token)) {
...
function is_interpolation_qualification(token) {
  return token.data === 'smooth' ||
    token.data === 'flat'
}
